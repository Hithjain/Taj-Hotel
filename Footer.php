...
<footer style="background-color: #393939;">
	...
	<div class="col-sm-4 hov">
		<img src="logo/logo2.jpeg"width="200px"height="50px"/><br><br>
...
?>
	...
	<div class="col-sm-4 text-justify">
      ...
      <p style="color:white;"><strong>Address:&nbsp;</strong>Chhatrapati Shivaji International Airport, T1, Off, Western Express Hwy, Navpada, Vile Parle East, Santacruz East, Mumbai, Maharashtra 400099</p>
      <p style="color:white;"><strong>Email-Id:&nbsp;</strong>taj@gmail.com</p>
      <p style="color:white;"><strong>Contact Us:&nbsp;</strong>(+91) 8108812900</p><br><br><br>
     <center>
       <center><img src="image/devlop/img2.jpeg"class="img-responsive"style="width:230px;height:180px;"></center>
	</div>&nbsp;
